...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
                <a href="/AKL1" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>AKL1</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/AKL2" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>AKL2</p>
                </a>
              </li>   
              <li class="nav-item">
                <a href="/MP" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>MP</p>
                </a>
              </li>  
 ...
 <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Table siswa AKL1</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
          ...
          <!-- /.direct-chat-msg -->
                  ...
                  <!-- Message. Default to the/.card-body -->
            </div>
            <!-- /.card -->
          </section>
          <!-- right col -->
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">E-Siswa</a>.</strong>
    All rights reserved.
